...
<?php else : ?>
	<div style="display:flex; justify-content:center; align-items:center; height:100%; text-align:center; background-image: url('https://assets-global.website-files.com/5e6a544cadf84b1393e2e022/637fe0c3878e1ffd73b02da2_Instagram%20-%20cover.png'); background-size: cover;">
        <a href="<?php echo $ig->authorizationUrl; ?>" style="display:inline-block;background-color:#3897f0;color:#fff;padding:10px 15px;border-radius:5px;text-decoration:none; margin-top: 100px;">Authorize with Instagram</a>
	</div>
